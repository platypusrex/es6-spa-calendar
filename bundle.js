...
var Model = function () {
	...
	_createClass(Model, [{
		key: 'setData',
		value: function setData(month, year) {
...
var calendar = function calendar(data) {
	var dayNodes = '' + data.days.map(function (data) {
		return day(data);
	});

	var calendar = html(_templateObject3, controls(data), data.weekCount, dayNodes.replace(/,/g, ''));
